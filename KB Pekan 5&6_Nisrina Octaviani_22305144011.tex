...
\begin{eulercomment}
Terdapat fungsi-fungsi plot yang sangat mendasar. Ada koordinat layar
yang selalu berkisar dari 1 hingga 1024 di setiap sumbu, tidak peduli
apakah layarnya pesergi atau tidak. Dan ada koordinat plot yang dapat
diatur dengan setplot (). Pemetaan antara koordinat tergantung pada
jendela plot saat ini. Misalnya, shrinkwindow() menyisakan ruang untuk
label sumbu dan judul plot.

Dalam contoh, kita hanya menggambar beberapa garis yang beragam warna.
Untuk lebih detail pada fungsi-fungsi tersebut, pelajari fungsi inti
dari EMT.
\end{eulercomment}
\begin{eulerprompt}
>clg; // clear screen
...
\end{eulerprompt}
\eulerimg{27}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-001.png}
\begin{eulerprompt}
>reset;
\end{eulerprompt}
\begin{eulercomment}
...
Untuk membersihkan semuanya kita dapat menggunakan reset().
...
Contoh lainnya, kita menggambar sebuah plot sebagagi sisipan di plot
...
margin sesuai kebutuhan. Perhatikan bahwa kita menyimpan dan
memulihkan jendela penuh dan menahan plot saat kita memplot inset.
\end{eulercomment}
\begin{eulerprompt}
>plot2d("x^3-x");
...
>plot2d("x^4-x",grid=6):
\end{eulerprompt}
\eulerimg{27}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-002.png}
\begin{eulerprompt}
>hold off;
>window(ow);
\end{eulerprompt}
\begin{eulercomment}
Sebuah plot dengan beberapa angka dicapai dengan cara yang sama. Untuk
hal ini ada fungsi utility figure().
...
\end{eulerprompt}
\eulerimg{13}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-003.png}
\begin{eulerprompt}
>aspect();
>reset;
\end{eulerprompt}
...
- ekspresi,\\
- fungsi, veraibel, atau kurva parameter,\\
...
>plot2d("x^2"):
\end{eulerprompt}
\eulerimg{27}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-004.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("x^3-x"):
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-005.png}
\begin{eulerprompt}
>a:=5.6; plot2d("exp(-a*x^2)/a"); insimg(30); // menampilkan gambar hasil plot setinggi 25 baris
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-006.png}
\begin{eulercomment}
...
>plot2d("x^3-x",-1,2):
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-007.png}
\begin{eulerprompt}
>plot2d("sin(x)",-2*pi,2*pi): // plot sin(x) pada interval [-2pi, 2pi]
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-008.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(3*x)",xmin=0,xmax=2pi):
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-009.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-010.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-012.png}
\begin{eulerprompt}
>plot2d("sin(x)+cos(2*x)",0,4pi):
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-013.png}
\begin{eulercomment}
...
jumlah subinterval dengan n = ... Ini hanya diperlukan dalam kasus
yang jarang terjadi.
\end{eulercomment}
\begin{eulerprompt}
>plot2d("sign(x)*exp(-x^2)",-1,1,<adaptive,n=10000):
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-014.png}
\begin{eulerprompt}
>plot2d("x^x",r=1.2,cx=1,cy=1):
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-015.png}
\begin{eulercomment}
...
>plot2d("log(x)",-0.1,2):
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-016.png}
\begin{eulercomment}
...
>plot2d("x^3-x",>square):
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-017.png}
\begin{eulerprompt}
>plot2d(''integrate("sin(x)*exp(-x^2)",0,x)'',0,2): // plot integral
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-020.png}
\begin{eulerprompt}
>a:=5.6; expr &= exp(-a*x^2)/a; // define expression
>plot2d(expr,-2,2): // plot from -2 to 2
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-021.png}
\begin{eulerprompt}
>plot2d(expr,r=1,thickness=2): // plot in a square around (0,0)
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-022.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),>add,style="--",color=red): // add another plot
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-023.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x,2),a=-2,b=2,c=-2,d=1): // plot in rectangle
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-024.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),a=-2,b=2,>square): // keep plot square
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-025.png}
\begin{eulerprompt}
>plot2d("x^2",0,1,steps=1,color=red,n=10):
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-026.png}
\begin{eulerprompt}
>plot2d("x^2",>add,steps=2,color=blue,n=10):
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-027.png}
\eulerheading{Fungsi Pada Satu Parameter}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-028.png}
\begin{eulerprompt}
>plot2d("f",0,1;0.4): // plot with a=0.4
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-029.png}
\begin{eulerprompt}
>plot2d(\{\{"f",0.2\}\},0,1): // plot with a=0.2
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-030.png}
\begin{eulerprompt}
>plot2d(\{\{"f(x,b)",b=0.1\}\},0,1): // plot with 0.1
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-031.png}
\begin{eulerprompt}
>function f(x) := x^3-x; ...
>plot2d("f",r=1):
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-032.png}
\begin{eulercomment}
...
>plot2d(f,0,2):
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-033.png}
\begin{eulercomment}
...
>plot2d(expr,0,3pi):
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-034.png}
\begin{eulerprompt}
>function f(x) &= x^x;
>plot2d(f,r=1,cx=1,cy=1,color=blue,thickness=2);
>plot2d(&diff(f(x),x),>add,color=red,style="-.-"):
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-038.png}
...
\end{eulerprompt}
\eulerimg{25}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-039.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("sin(x)",0,2pi); plot2d("cos(x)",color=blue,style="--",>add):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-041.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-042.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-044.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-045.png}
\begin{eulercomment}
...
>plot2d(x,y):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-046.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-047.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-048.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-049.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-051.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-052.png}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-053.png}
\begin{eulerprompt}
>expr := "log(x)/x"; ...
>  plot2d(expr,0.5,5,title="y="+expr,xl="x",yl="y"); ...
>  label("(1,0)",1,0); label("Max",E,expr(E),pos="lc"):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-054.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-055.png}
\begin{eulercomment}
...
>tcolor=black,>left):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-056.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-057.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-058.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-059.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-060.png}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-061.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-062.png}
\begin{eulercomment}
...
>  x=0.7,y=0.2):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-063.png}
\begin{eulercomment}
\end{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-064.png}
\begin{eulerprompt}
>plot2d("exp(x)*sin(x)",user=true, ...
>  title="+/- or cursor keys (return to exit)"):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-065.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-066.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-067.png}
\begin{eulercomment}
...
>plotf(nd):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-068.png}
\begin{eulercomment}
...
> figure(0):
\end{eulerprompt}
\eulerimg{25}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-069.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-070.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-071.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-072.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-073.png}
\begin{eulercomment}
Ada juga kotak teks.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-074.png}
\begin{eulerprompt}
>plot2d(["exp(x)","1+x"],color=[black,blue],style=["-","-.-"]):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-075.png}
\begin{eulerprompt}
...
> reset():
\end{eulerprompt}
\eulerimg{25}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-076.png}
\begin{eulercomment}
...
> reset:
\end{eulerprompt}
\eulerimg{25}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-077.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-078.png}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-079.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-080.png}
\begin{eulerprompt}
>p=polyfit(xdata,ydata,1); // get regression line
>plot2d("polyval(p,x)",>add,color=red): // add plot of line
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-081.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{13}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-082.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-083.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); ...
>plot2d(cos(t),sin(t),>filled,style="/",fillcolor=red,r=1.2):
\end{eulerprompt}
\eulerimg{13}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-084.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); plot2d(cos(t),sin(t),>filled,style="#"):
\end{eulerprompt}
\eulerimg{13}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-085.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-086.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-087.png}
\begin{eulercomment}
...
bisa diisi. Pada kasus ini menghasilkan hasil yang bagus karena aturan
lilitan, yang digunakan untuk isi.
\end{eulercomment}
\begin{eulerprompt}
>plot2d(x,y,<grid,<frame,>filled):
\end{eulerprompt}
\eulerimg{13}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-088.png}
\begin{eulercomment}
...
> plot2d(t,t,add=true):
\end{eulerprompt}
\eulerimg{13}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-089.png}
\begin{eulercomment}
...
>plot2d(t,y):
\end{eulerprompt}
\eulerimg{13}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-090.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-091.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-093.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(x)^3",xmin=0,xmax=2pi,>filled,style="/"):
\end{eulerprompt}
\eulerimg{13}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-094.png}
...
\end{eulerprompt}
\eulerimg{13}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-096.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-097.png}
\begin{eulerprompt}
>t=linspace(0,1,1000); r=exp(-t); x=r*cos(2pi*t); y=r*sin(2pi*t);
>plot2d(x,y,r=1):
\end{eulerprompt}
\eulerimg{13}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-098.png}
\begin{eulercomment}
Dalam contoh berikutnya, kita memplot kurva
...
\end{eulerprompt}
\eulerimg{13}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-101.png}
...
\end{eulerprompt}
\eulerimg{25}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-102.png}
\begin{eulerprompt}
>aspect(1.25); r=linspace(0,1,50); a=linspace(0,2pi,200)'; z=r*exp(I*a);
>plot2d(exp(z),cgrid=[40,10]):
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-103.png}
\begin{eulerprompt}
>r=linspace(0,1,10); a=linspace(0,2pi,40)'; z=r*exp(I*a);
>plot2d(exp(z),>points,>add):
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-104.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-106.png}
...
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-107.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-108.png}
\begin{eulerprompt}
>columnsplot(cumsum(random(10)),style="/",color=blue):
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-109.png}
\begin{eulercomment}
...
>title("Temperature"):
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-110.png}
\begin{eulerprompt}
>k=0:10;
>plot2d(k,bin(10,k),>bar):
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-111.png}
\begin{eulerprompt}
>plot2d(k,bin(10,k)); plot2d(k,bin(10,k),>points,>add):
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-112.png}
\begin{eulerprompt}
>plot2d(normal(1000),normal(1000),>points,grid=6,style=".."):
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-113.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution,style="O"):
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-114.png}
\begin{eulerprompt}
>plot2d("qnormal",0,5;2.5,0.5,>filled):
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-115.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-116.png}
\begin{eulercomment}
...
>plot2d(x,y,>bar):
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-117.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-118.png}
\begin{eulerprompt}
>n=10; i=0:n; ...
>plot2d(i,bin(n,i)/2^n,a=0,b=10,c=0,d=0.3); ...
>plot2d(i,bin(n,i)/2^n,points=true,style="ow",add=true,color=blue):
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-119.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-120.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-121.png}
\begin{eulerprompt}
>k=0:10; m=bin(10,k); x=(0:11)-0.5; plot2d(x,m,>bar):
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-122.png}
\begin{eulerprompt}
>columnsplot(m,k):
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-123.png}
\begin{eulerprompt}
>plot2d(random(600)*6,histogram=6):
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-124.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-125.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-126.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-127.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution); ...
>  plot2d("qnormal(x)",color=red,thickness=2,>add):
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-128.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-129.png}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-131.png}
\begin{eulerprompt}
>expr := "2*x^2+x*y+3*y^4+y"; // define an expression f(x,y)
>plot2d(expr,level=0): // Solutions of f(x,y)=0
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-132.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,contourcolor=white,n=200): // nice
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-133.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,>spectral,n=200,grid=4): // nicer
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-134.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-135.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",>contour,>hue,>spectral):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-136.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",level=0,contourwidth=3,>add,contourcolor=red):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-137.png}
\begin{eulerprompt}
>z=z+normal(size(z))*0.2;
>plot2d(z,level=0.5,a=-1,b=2,c=-2,d=1):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-138.png}
\begin{eulerprompt}
>plot2d(expr,level=[0:0.2:5;0.05:0.2:5.05],color=lightgray):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-139.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=1,r=4,n=100):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-140.png}
\begin{eulerprompt}
>plot2d("x^2+2*y^2-x*y",level=0:0.1:10,n=100,contourcolor=white,>hue):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-141.png}
\begin{eulercomment}
...
>plot2d(expr,level=[0;1],style="-",color=blue): // 0 <= f(x,y) <= 1
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-143.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-144.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=[0,2,4;1,3,5],style="/",r=2,n=100):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-145.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=-10:20,r=2,style="-",dl=0.1,n=100):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-146.png}
\begin{eulerprompt}
>plot2d("sin(x)*cos(y)",r=pi,>hue,>levels,n=100):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-147.png}
\begin{eulercomment}
...
>  level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-149.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-151.png}
\begin{eulerprompt}
...
\end{eulerudf}
\begin{eulercomment}
Tidak ada kotak atau sumbu kutu di sini. Selain itu, kita menggunakan
...
\end{eulerprompt}
\eulerimg{25}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-152.png}
\begin{eulercomment}
...
>logimpulseplot1(x,y):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-153.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-154.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",0,100,logplot=1):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-155.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",10,100,logplot=2):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-156.png}
\begin{eulerprompt}
>plot2d("gamma(x)",1,10,logplot=1):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-157.png}
\begin{eulerprompt}
>plot2d("log(x*(2+sin(x/100)))",10,1000,logplot=3):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-158.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-159.png}
...
\begin{eulercomment}
1. Nilai fungsi berikut ketika x nya bernilai 4 adalah?\\
\end{eulercomment}
\begin{eulerformula}
\[
f(x)=2x+4
...
>plot2d("2*x+4",0,5):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-161.png}
\begin{eulercomment}
Dari grafik tersebut terlihat bahwa ketika x bernilai 4 maka fungsi
tersebut bernilai 12.
...
\end{eulerformula}
\begin{eulerprompt}
>plot2d("sin(x)+cos(x)",-1,2):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-163.png}
\begin{eulercomment}
Dari grafik di atas terlihat bahwa ketika x bernilai 90 derajat, maka
fungsi tersebut bernilai 1.

3. Berapa nilai fungsi berikut ketika x nya bernilai 2\\
\end{eulercomment}
\begin{eulerformula}
\[
f(x)=2^x+4
...
>plot2d("2^x+4",0,3):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-165.png}
\begin{eulercomment}
Dari grafik di atas terlihat bahwa ketika x bernilai 2 maka fungsi
tersebut bernilai 8.

4. Berapa nilai fungsi berikut ketika x nya bernilai 1\\
\end{eulercomment}
\begin{eulerformula}
\[
f(x)= x^2+2*x+4
...
\end{eulerformula}
\begin{eulerprompt}
>plot2d("x^2+2*x+4",0,2):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-167.png}
\begin{eulercomment}
Dari grafik di atas terlihat bahwa ketika x bernilai 1 maka fungsi
tersebut bernilai 7.

5. Gambarkan grafik fungsi logaritma berikut\\
\end{eulercomment}
\begin{eulerformula}
\[
f(x)=logx^2
...
>plot2d("log(x^2)",0,4):
\end{eulerprompt}
\eulerimg{16}{images/KB Pekan 5&6_Nisrina Octaviani_22305144011-169.png}
\begin{eulercomment}
Dari grafik di atas terlihat bahwa ketika x bernilai 10 maka fungsi
tersebut bernilai 2.
\end{eulercomment}
\end{eulernotebook}
